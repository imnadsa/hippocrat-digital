...
export default function TargetingFaq() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Да, обязательно! Мы устанавливаем пиксели VK Telegram, настраиваем Яндекс Вебмасте/Uis и корректно настраиваем отслеживание конверсий. Без аналитики невозможно оптимизировать кампании."
    },
    {
      question: "Какие социальные сети лучше для рекламы медицинских услуг?",
      answer: "Если мы говорим про таргетированную рекламу, то несомненно в России - ВК и ТГ. Выбираем платформы под конкретную клинику и услуги."
    },
    {
    ...
    },
    {
      ...
      answer: "Еженедельная оптимизация кампаний, тестирование новых аудиторий и объявлений, корректировка ставок, анализ конкурентов, регулярная отчетность, обратная связь и рекомендации по улучшению конверсии."
    },
    {
