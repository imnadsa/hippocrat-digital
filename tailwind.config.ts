  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Добавляем градиентные цвета для удобства, сохраняя цвета из Hippocrat AI
        gradient: {
          blue: "#4A9EFF",
          purple: "#8A4AFF",
          teal: "#2DD4BF",
      ...
      animation: {
        ...
        "slide-in": "slide-in-top 0.3s ease forwards",
        "pulse-slow": "pulse-slow 3s cubic-bezier(0.4, 0, 0.6, 1) infinite",
        "float": "float 6s ease-in-out infinite",
      },
      screens: {
        xs: "475px", // Добавляем экстра-маленький размер
      },
      fontSize: {
        xxs: "0.625rem", // Для маленьких подписей на мобильных устройствах
      },
      backdropBlur: {
        xs: "2px",
      },
