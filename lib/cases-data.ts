...
import { CaseData } from '@/lib/cases-data'
...
export default function CaseModal({ isOpen, onClose, caseData }: CaseModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative w-full max-w-4xl max-h-[90vh] md:max-h-[85vh] bg-slate-900 md:rounded-t-2xl md:rounded-b-2xl overflow-hidden animate-slideUp md:animate-scaleUp">
        {/* Header */}
        <div className="sticky top-0 z-10 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-white font-fixedsys">
                {caseData.title}
              </h2>
